    ...
    return (
        <div>
            ...
            <div className='relative flex items-center '>
                ...
                <div className="w-full left-0 right-0 container mx-auto px-2 absolute flex justify-between z-10">
  <button
    onClick={handleScrollLeft}
    className="bg-white hover:bg-gray-100 shadow-lg text-lg p-2 rounded-full"
  >
    <FaAngleLeft />
  </button>
  <button
    onClick={handleScrollRight}
    className="bg-white hover:bg-gray-100 shadow-lg p-2 text-lg rounded-full"
  >
    <FaAngleRight />
  </button>
</div>
