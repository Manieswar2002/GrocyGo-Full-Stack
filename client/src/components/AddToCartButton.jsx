        ...
        <div className='w-full max-w-[150px]'>
            {
                isAvailableCart ? (
                    ...
                    <button onClick={handleADDTocart} className='bg-green-600 hover:bg-green-700 text-white px-3 lg:px-5 py-1 rounded-full shadow-md border border-green-500 hover:border-green-800 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg'>
                        {loading ? <Loading /> : "Add"}
                    </button>
                )
            }
