        ...
        <section className='w-full container mx-auto px-2'>
            <div className='bg-white my-4 w-full max-w-lg mx-auto rounded p-7'>
                ...
                <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
                    ...
                    <button
                        disabled={!isFormValid || loading} // Disabled if loading or form invalid
                        className={`${isFormValid && !loading ? "bg-green-800 hover:bg-green-700" : "bg-gray-500"} text-white py-2 rounded font-semibold my-3 tracking-wide`}
                    >
